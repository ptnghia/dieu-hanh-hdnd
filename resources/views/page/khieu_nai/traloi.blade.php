        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Trả lời khiếu nại</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Trả lời khiếu nại tố cáo</h5>
                    </div>
                    <hr>
                    <form class="row g-3" method="POST" action="{{ route('khieu-nai.tra-loi.traloi',$dataId->id)}}" id="upload_vanban">
                        @csrf
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 ms-3 khieu_nai_item_right">
                                ...
                                <div class="mb-3"><i class="bx bx-calendar"></i> {{date('d/m/Y', strtotime($dataId->ngay_khieu_nai))}}  - <i class="bx bx-purchase-tag"></i> {{$dataId->ten}}</div>
                                <div class="mb-3">
                                    {!!$dataId->noi_dung_khieu_nai!!}
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
