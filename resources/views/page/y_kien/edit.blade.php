        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Sửa thông tin văn bản</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Chi tiết</h5>
                    </div>
                    <hr>
                    <form class="row g-3" method="POST" action="{{ route($data_fix['module']['slug'].'.update', $dataId->id)}}" id="upload_vanban">
                        ...
                        <div class="col-12 col-lg-10 col-md-9">
                            ...
                            <input type="text" placeholder="Nhập tiêu đề văn bản"  name="ten" class="form-control @error('ten') is-invalid @enderror" value="{{old('ten') ?? $dataId->ten}}" id="inputTen">
                            @error('ten')
                        ...
                        <div class="col-lg-2 col-md-3 col-12">
                            ...
                            <input type="text" placeholder="Nhập số hiệu - ký hiệu"  name="so_hieu" class="form-control @error('so_hieu') is-invalid @enderror" value="{{old('so_hieu') ?? $dataId->so_hieu}}" id="inputTen">
                            @error('so_hieu')
                                <span class="invalid-feedback" role="alert">
                                    <i>{{ $message }}</i>
                                </span>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 form-select2 @error('loai_vanban_id') is-invalid @enderror">
                            ...
                            <select name="loai_vanban_id" class=" form-control single-select" id="loai_vanban_id">
                                ...
                                <option {{$dataId->loai_vanban_id==$row->id ? 'selected' : ''}} value="{{$row->id}}">{{$row->ten}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <select name="linh_vuc_id" class=" form-control single-select" id="linh_vuc_id">
                                ...
                                <option {{$dataId->linh_vuc_id==$row->id ? 'selected' : ''}} value="{{$row->id}}">{{$row->ten}}</option>
                                @endforeach
                            </select>
                            @error('linh_vuc_id')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 form-select2 @error('loai_vanban_id') is-invalid @enderror">
                            ...
                            <select name="coquan_banhanh_id" class=" form-control single-select" id="coquan_banhanh_id">
                                ...
                                <option {{$dataId->coquan_banhanh_id==$row->id ? 'selected' : ''}} value="{{$row->id}}">{{$row->ten}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <input type="date"  name="hieu_luc" placeholder="" class="form-control @error('hieu_luc') is-invalid @enderror" value="{{old('hieu_luc') ?? $dataId->hieu_luc }}" id="hieu_luc">
                            @error('hieu_luc')
                                <span class="invalid-feedback" role="alert">
                                    <i>{{ $message }}</i>
                                </span>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="mo_ta" id="mytextarea" rows="3" class="form-control @error('mo_ta') is-invalid @enderror">{{old('mo_ta') ?? $dataId->mo_ta}}</textarea>
                            @error('mo_ta')
                                <span class="invalid-feedback" role="alert">
                                    <i>{{ $message }}</i>
                                </span>
