                            ...
                            <div class="row">
                                <div class="col">
                                    @if (Auth::user()->permissions_id > 1)
                                        ...
                                        <a href="{{route('khieu-nai.tra-loi.traloi', $item->id)}}" class="btn-icon py-1 btn btn-sm btn-success size-15"><i class="bx bx-detail"></i> Trả lời</a>
                                        @else
                                        <a href="{{route('khieu-nai.tra-loi.traloi', $item->id)}}" class="ms-2 btn-icon py-1 btn btn-sm btn-warning px-2 size-14"><i class="bx bx-edit-alt"></i>Sửa nội dung trả lời</a>
                                        @endif
                                    @else
                                        @if  ($item->noi_dung_tra_loi != '')  
                                ...
                                <div class="col d-flex justify-content-end">
                                    <a href="{{route('khieu-nai.show', $item->id)}}" class="btn-icon py-1 btn btn-sm btn-info size-15 mx-2"><i class="bx bx-detail"></i> xem chi tiết</a>
                                    ...
                                    @endif
                                    <button class="btn btn-warning btn-sm" onclick="theodoi_khieunai({{$item->id}})"><i class="bx bx-bell"></i></button>
                                </div>
