            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title d-flex align-items-center">
                        ...
                        <h5 class="mb-0 text-primary">Nội dung ý kiến cử tri</h5>
                    </div>
                    <hr>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3 khieu_nai_item_right">
                            ...
                            <div class="mb-3"><i class="bx bx-calendar"></i> {{date('d/m/Y', strtotime($data->ngay_y_kien))}}  - <i class="bx bx-purchase-tag"></i> {{$data->ten}}</div>
                            <div class="mb-3">
                                {!!$data->noi_dung_y_kien!!}
                            </div>
                            <hr>
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="">
                            <a href="{{route('y-kien-cu-tri.tra-loi.traloi', $data->id)}}" class="btn-icon py-1 btn btn-sm btn-success size-15"><i class="bx bx-detail"></i> Trả lời</a>
                        </div>
                        <div class=" d-flex justify-content-end">
                            <a href="{{route('y-kien-cu-tri.show', $data->id)}}" class="btn-icon py-1 btn btn-sm btn-info size-15"><i class="bx bx-detail"></i>Chi tiết</a>
